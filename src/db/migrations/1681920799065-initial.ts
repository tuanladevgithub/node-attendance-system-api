...
export class Initial1681920799065 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`t_attendance_result\` ADD CONSTRAINT \`FK_db572fdad6ea3b58cf9d96072b0\` FOREIGN KEY (\`attendanceStatusId\`) REFERENCES \`t_attendance_status\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE \`t_attendance_status\``);
