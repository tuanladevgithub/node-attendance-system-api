...
export class Initial1683645171709 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`t_teacher\` (\`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`teacher_code\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`last_name\` varchar(255) NOT NULL, \`first_name\` varchar(255) NOT NULL, \`gender\` varchar(255) NOT NULL, \`description\` mediumtext NULL, UNIQUE INDEX \`IDX_75285f37c6e2c0e0249e66d5ff\` (\`teacher_code\`), UNIQUE INDEX \`IDX_c7fdc528f5d440bf14d75803fc\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`t_student\` (\`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`teacher_code\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`last_name\` varchar(255) NOT NULL, \`first_name\` varchar(255) NOT NULL, \`gender\` varchar(255) NOT NULL, \`age\` int NULL, UNIQUE INDEX \`IDX_1c70c17caec9eab453b255cbd3\` (\`teacher_code\`), UNIQUE INDEX \`IDX_d51de5a12b5a5be6e21911c0f9\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`t_course\` (\`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`t_teacher_id\` int NOT NULL, \`course_code\` varchar(255) NOT NULL, \`course_name\` varchar(255) NOT NULL, \`description\` mediumtext NULL, \`start_date\` varchar(255) NOT NULL, \`end_date\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`t_attendance_result\` (\`t_attendance_session_id\` int NOT NULL, \`t_student_id\` int NOT NULL, \`m_attendance_status_id\` int NULL, \`record_time\` datetime NULL, \`ip_address\` varchar(255) NOT NULL, PRIMARY KEY (\`t_attendance_session_id\`, \`t_student_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
